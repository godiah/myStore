...
<html lang="en">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 d-none d-lg-block d-md-block-d-sm-block d-xs-none text-end">
            <span class="me-3" id="about_vertical">
              <a class="text-muted text-decoration-none" href="aboutus.html">About Us</a>
            </span>
    ...
    <nav class="navbar navbar-expand-lg bg-white sticky-top navbar-light p-3 shadow-sm">
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
          ...
          <ul class="navbar-nav ms-auto"> 
            <li class="nav-item">
              <a class="nav-link mx-2 " href="#"><i class="fa-solid fa-basket-shopping"></i><sup>2</sup> Cart</a>
            </li>           
            <li class="nav-item">
  ...
  <main>
    ...
    <section class="categories">
      <div class="board">
        <div class="wrapper">
          <div class="product1">
            <div class="image">
              <img src="images/product1.jpg" alt="TP Link Equipment">
            </div>
            <div class="title">
    ...
    <div class="cpy_">
      ...
      <a href="#"><img class="footer_img" src="images/twitter.png" alt="..."></a>
      <a href="#"><img class="footer_img" src="images/facebook.png" alt="..."></a>
      <a href="#"><img class="footer_img" src="images/insta.png" alt="..."></a>
